/* $Header: /baz/users/cvs-root/emulator/interface.c,v 1.1.1.1 1994/11/21 14:44:29 fcp Exp $ */
/*
...
**		       	     $Date: 1994/11/21 14:44:29 $
**	Currently locked by: $Locker:  $
**			     $Revision: 1.1.1.1 $
**			     $Source: /baz/users/cvs-root/emulator/interface.c,v $
**
*/
